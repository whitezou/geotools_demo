...
//        featureLab.addFeaturePolygon("wkt");
    ...
    public void addFeaturePolygon(String type) throws Exception {
        ...
        SimpleFeatureBuilder featureBuilder = new SimpleFeatureBuilder(TYPE);
        //    创建要素并添加到集合
        Coordinate[] coordinates = new Coordinate[]{new Coordinate(20, 10), new Coordinate(30, 0), new Coordinate(40, 10), new Coordinate(30, 10), new Coordinate(30, 20), new Coordinate(20, 10)};
        ...
        if (type.equals("feature")) {
            ...
            WKTReader reader = new WKTReader(geometryFactory);
            polygon = (Polygon) reader.read("POLYGON((20 10, 30 0, 40 10, 30 10, 30 20, 20 10))");
        }
        String name = "添加区";
        int num = Integer.parseInt("16");
        //    添加的数据一定安装SimpleFeatureType给的字段顺序进行赋值
